...
from imagesearch_app import app, db, bcrypt
from imagesearch_app.forms import RegistrationForm, LoginForm, UpdateAccountForm 
from imagesearch_app.models import User, Post
from flask_login import login_user, current_user, logout_user, login_required
from werkzeug.utils import secure_filename

from imagesearch_app import image_search
from imagesearch_app.settings import QUERY_IMAGE_FOLDER
...
def search():
    if request.method == 'POST':
        ...
        query_image_path = os.path.join(
            QUERY_IMAGE_FOLDER, f.filename)
        f.save(query_image_path)
        # Get search results. Currently this is done
        # locally. An API can be created to ping a 
        # server to compute this.
        results = image_search.search(query_image_path)
